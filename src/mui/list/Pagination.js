    ...
    renderPageNums() {
        return this.range().map(pageNum =>
            (pageNum === '.') ?
                ...
                <FlatButton className="page-number" data-page={pageNum} key={pageNum} label={pageNum} data-page={pageNum} onClick={::this.gotoPage} primary={pageNum !== this.props.page} style={buttonStyle} />
        );
    }
